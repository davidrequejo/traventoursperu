...
@php
  $user = auth()->user();
  $user?->loadMissing('persona.cargo');
  $userName = $user?->display_name ?? 'Usuario';
  $userRole = $user?->display_role ?? 'Usuario autenticado';
  $userId = $user?->id ? str_pad($user->id, 5, '0', STR_PAD_LEFT) : '00000';
  $fallbackPhoto = asset('assets/modulo/persona/perfil/hombre.png');
  $profilePhoto = $user?->profile_photo_url ?? $fallbackPhoto;
@endphp
  ...
  <div class="main-header-container container-fluid">
    ...
    <div class="header-content-right" >
      ...
      <div class="header-element header-search" >
        <!-- Start::header-link -->
        <a href="javascript:void(0);" class="header-link" data-bs-toggle="modal" data-bs-target="#searchModal" aria-label="Buscar en el menu" title="Buscar en el menu">
          <i class="bx bx-search-alt header-link-icon"></i> 
        </a>
        <!-- End::header-link -->
      </div>
      <!-- End::header-element -->
      ...
      <div class="header-element country-selector">
        ...
        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
          <img src="{{ asset('ynex_admin/images/flags/peru_flag.png') }}" alt="img" class="rounded-circle header-link-icon" />
        </a>
          ...
          <li>
            <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
              <span class="avatar avatar-xs lh-1 me-2">
                <img src="{{ asset('ynex_admin/images/flags/peru_flag.png') }}" alt="img" />
              </span>
              Spanish
            </a>
          </li> 
      ...
      <div class="header-element header-shortcuts-dropdown">
        ...
        <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" id="notificationDropdown" aria-expanded="false">
          <i class="bx bx-grid header-link-icon"></i>
        </a>
        <!-- End::header-link|dropdown-toggle -->
        <!-- Start::main-header-dropdown -->
            ...
            <div class="row g-2">
                ...
                <a href="https://www.facebook.com/profile.php?id=100086343481837" target="_blank">
                  <div class="text-center p-3 related-app">
                    <span class="avatar avatar-sm avatar-rounded">
                      <img src="{{ asset('ynex_admin/images/jdl/logo-facebook.jpg') }}" alt="" />
                    </span>
              ...
              <div class="col-4">
                <a href="https://www.instagram.com/jdltechnology/" target="_blank">
                  <div class="text-center p-3 related-app">
                    <span class="avatar avatar-sm avatar-rounded">
                      <img src="{{ asset('ynex_admin/images/jdl/logo-instagram.jpg') }}" alt="" />
                    </span>
              ...
              <div class="col-4">
                <a href="https://www.tiktok.com/@jdltechnology" target="_blank">
                  <div class="text-center p-3 related-app">
                    <span class="avatar avatar-sm avatar-rounded">
                      <img src="{{ asset('ynex_admin/images/jdl/logo-tiktok.jpg') }}" alt="" />
                    </span>
        ...
        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
          <div class="d-flex align-items-center">
            <div class="me-sm-2 me-0">
              <img src="{{ $profilePhoto }}" alt="img" width="32" height="32" class="rounded-circle" onerror="this.src='{{ $fallbackPhoto }}';" />
            </div>
            <div class="d-sm-block d-none">
              <p class="fw-semibold mb-0 lh-1">{{ $userName }}</p>
              <span class="op-7 fw-normal d-block fs-11">{{ $userRole }}</span> 
            </div>
          </div>
        </a>
        <!-- End::header-link|dropdown-toggle -->
        <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
          <li><a class="dropdown-item d-flex" href="javascript:void(0);" onclick="toastr_info('Este es su ID', 'Su identificador <b>{{ $userId }}</b> sera usado para todos los cambios que realice en el sistema.', 700)" ><i class="ti ti-fingerprint fs-18 me-2 op-7"></i>{{ $userId }}</a></li>          
          <li><a class="dropdown-item d-flex" href="{{ route('perfil.seguridad') }}"><i class="ti ti-user-circle fs-18 me-2 op-7"></i>Perfil</a></li>          
          @permiso('empresa', 'ver')
          <li><a class="dropdown-item d-flex" href="{{ route('empresa.index') }}"><i class="ti ti-adjustments-horizontal fs-18 me-2 op-7"></i>Empresa</a></li>          
          @endpermiso
