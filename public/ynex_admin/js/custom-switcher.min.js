...
function switcherClick() {
    ...
    // anclarMenu = document.querySelector('#anclar-menu-personalizado'); // Realizado a Pedido de cliente
    ...
    // let anclarMenuVar = anclarMenu.addEventListener('click', () => {

    //     var estado = document.querySelector('html').getAttribute("data-vertical-style");

    //     if (estado == 'default') {
    //         anclarMenu.classList.replace('bg-secondary-transparent', 'bg-warning-transparent');
    //         anclarMenu.innerHTML = '<i class="bi bi-pin fs-13 cursor-pointer"></i>';
    ...
    //         });
    //     } else {
    //         anclarMenu.classList.replace('bg-warning-transparent', 'bg-secondary-transparent');
    //         anclarMenu.innerHTML = '<i class="bi bi-pin-angle-fill fs-13 cursor-pointer text-info"></i>';
    //         html.setAttribute('data-vertical-style', 'default');
    //         html.setAttribute('data-nav-layout', 'vertical');
    //         document.querySelector('html').setAttribute('data-vertical-style', 'default');
    //         toggleSidemenu();
    //         // localStorage.removeItem("ynexverticalstyles");
    //         localStorage.setItem("ynexverticalstyles", 'default');
    //         document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", "../ynex_admin/libs/bootstrap/css/bootstrap.min.css");
    }
...
function rtlFn() {
    ...
    document.querySelector("#style")?.setAttribute("href", "../ynex_admin/libs/bootstrap/css/bootstrap.rtl.min.css");
    checkOptions();
}
...
function lightFn() {
    ...
    if(!localStorage.getItem('primaryRGB')){
        html.setAttribute('style','78, 172, 76')
    }
...
function checkOptions() {
    ...
    if (localStorage.ynexverticalstyles) {
        let verticalStyles = localStorage.getItem('ynexverticalstyles'); console.log(`menuClose: ${verticalStyles}`);     
