...
function toggleSidemenu() {
  ...
  if (window.innerWidth >= 992) {
    if (sidemenuType === "vertical") {
      ...
      let verticalStyle = html.getAttribute('data-vertical-style'); //console.log(`menuClose: ${verticalStyle}`);      
      switch (verticalStyle) {
        ...
        // default
        case 'default':
          // iconOverayFn(); // No activar para: Default - 24/05/2025
          html.removeAttribute('data-toggled');
...
function setNavActive() {
  let currentPath = location.pathname == "/" ? "index.html" : location.pathname.replace(/^\/+|\/+$/g, "");
  ...
  sidemenuItems.forEach(e => {
    ...
    if (normalizeMenuPath(e.getAttribute('href')) === currentPath) {
